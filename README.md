...
I've noticed that I don't close input files consistently. Files are closed when the program exits anyway, but sometimes I make it a point to close the input file when I want to remind myself all information has been parsed in. I won't be cleaning these up either.
